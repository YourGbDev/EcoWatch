...
<body class="bg-gray-50 min-h-screen p-8">
    <main class="max-w-2xl mx-auto">
        ...
        <h1 class="text-3xl font-bold mb-2">Submit New Report</h1>
        <p class="text-gray-500 mb-8">Help your community by reporting environmental issues.</p>
        ...
        <form id="submit-report-form" class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 transition-all duration-300 space-y-6">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <button type="button" onclick="selectCategory(this, 'flooding')" class="btn-cat btn-flood p-4 rounded-2xl font-semibold border-2 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98]">Flood</button>
        ...
        <div id="submit-success" class="hidden bg-white p-8 rounded-3xl shadow-sm border border-gray-100 text-center mt-6">
            ...
            <div class="flex space-x-4">
                <a href="my_reports.php" class="flex-1 bg-brand-blue text-white py-3 rounded-xl font-semibold hover:bg-blue-700 transition">View My Reports</a>
...
<script>
    ...
    document.getElementById('submit-report-form').addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('api/submit_report.action.php', {
                method: 'POST',
                body: formData
            });
